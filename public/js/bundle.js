...
var displayMap = function displayMap(tourLocations) {
  ...
  tourLocations.forEach(function (location) {
    ...
    element.className = 'location-pin'; // Add markers to the map

    new mapboxgl.Marker({
      element: element,
      anchor: 'bottom'
    }).setLngLat(location.coordinates).addTo(map); // Add popup information for each marker
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              url: '/api/v1/users/forgotMyPassword',
              data: {
                email: email
              }
            });
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              url: "/api/v1/users/resetMyPassword/".concat(token),
              data: {
                password: password,
                passwordConfirm: passwordConfirm
              }
          ...
          case 7:
            ...
            } else if (_context.t0.response.data.message === 'There is no user associated with that token') {
              (0, _sweetalert.default)('Password Reset Token Expired!', 'Please make another request to reset your password.', 'error');
            }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "23212" + '/');
